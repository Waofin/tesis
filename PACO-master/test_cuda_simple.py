"""
Script simple para probar la implementación CUDA.

Este script verifica que:
1. CuPy está instalado correctamente
2. La GPU es accesible
3. Las funciones básicas funcionan
"""
...
print("=" * 70)
print("TEST SIMPLE: Implementación CUDA")
print("=" * 70)
...
try:
    ...
    if n_devices > 0:
        ...
        print(f"   [OK] Test basico GPU: sum([1,2,3,4,5]) = {result}")
    else:
...
# Test 5: Comparar con CPU
print("\n5. Comparando GPU vs CPU...")
try:
...
print("  python benchmark_cuda.py")
